...
const outpatientEmergencyTreatmentContrast = () =>
  import("../../components/table/outpatientEmergencyTreatmentContrast");
...
export default {
  data() {
    return {
      ...
      showCom: "outpatientEmergencyTreatmentContrast",
      flag: false,
      tableList: [],
      pickerBegin: {
        disabledDate: (time) => {
  ...
  components: {
    outpatientEmergencyTreatmentContrast,
  },
  watch: {
    form: {
      immediate: true,
