    ...
    <div class="topside">
      <el-form :model="form" :inline="true">
        ...
        <el-form-item label="排序方式：">
          <el-radio v-model="form.grade" label="0">按病案号</el-radio>
          <el-radio v-model="form.grade" label="1">按出院日期</el-radio>
          <el-radio v-model="form.grade" label="2">按姓名</el-radio>
        </el-form-item>
        <el-form-item>
...
const illnessClassifyRegister = () =>
  import("../../components/table/illnessClassifyRegister");
...
export default {
  data() {
    return {
      ...
      showCom: "illnessClassifyRegister",
      flag: false,
      tableList: [],
      pickerBegin: {
        disabledDate: (time) => {
