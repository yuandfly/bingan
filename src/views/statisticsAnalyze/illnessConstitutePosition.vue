...
const illnessCategoryPositionStatistics = () =>
  import("../../components/table/illnessCategoryPositionStatistics");
...
export default {
  data() {
    ...
    return {
      ...
      showCom: "illnessCategoryPositionStatistics",
      flag: false,
      tableList: [],
      pickerBegin: {
        disabledDate: (time) => {
  ...
  components: {
    illnessCategoryPositionStatistics,
