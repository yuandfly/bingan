...
//
const infectiousDiseasesDepartmentQuality = () =>
  import("../../components/table/infectiousDiseasesDepartmentQuality");
...
export default {
  data() {
    return {
      ...
      showCom: "infectiousDiseasesDepartmentQuality",
      flag: false,
      tableList: [],
      pickerBegin: {
        disabledDate: (time) => {
  ...
  components: {
    infectiousDiseasesDepartmentQuality,
  },
  watch: {
    form: {
      immediate: true,
