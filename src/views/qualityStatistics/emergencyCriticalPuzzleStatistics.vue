...
//
const emergencyCriticalPuzzleStatistics = () =>
  import("../../components/table/emergencyCriticalPuzzleStatistics");
...
export default {
  data() {
    return {
      ...
      showCom: "emergencyCriticalPuzzleStatistics",
      flag: false,
      tableList: [],
      pickerBegin: {
        disabledDate: (time) => {
  ...
  components: {
    emergencyCriticalPuzzleStatistics,
  },
  watch: {
    form: {
      immediate: true,
