...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            validateCode () {
                if (this.id === 1) {
                    if (this.form.dm && this.form.dm.length !== 2) {
                        this.$message.error('民族代码必须为2个字符');
                        return true;
                    }
                } else if (this.id === 7) {
                    if (this.form.dm && this.form.dm.length !== 1) {
                        this.$message.error('重点医技诊断代码必须为1个字符');
                        return true;
                    }
                } else if (this.id === 9) {
                    if (this.form.dm && this.form.dm.length !== 2) {
                        this.$message.error('上报科室统计归口代码必须为2个字符');
                        return true;
                    }
                }
