<template>
    <div>
        <el-dialog title="添加手术名称"  :visible.sync="dialogFormVisible" width="800px">
            <el-form :model="form" ref="rulesFormRef" :rules="rulesForm">
                <el-row >
                    ...
                    <el-col :span="12">
                        <el-form-item label="手术名称" :label-width="formLabelWidth"  prop="dmmc">
                            <el-input v-model="form.dmmc" size="small"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="iccm" :label-width="formLabelWidth" prop="iccm">
                            <el-input v-model="form.iccm" size="small"></el-input>
                        </el-form-item>
                    </el-col>
...
<script>
    import { InsertOperationName } from "../../../api/index";
    export default {
        components: {
        },
        props: {
            ...
            addOutpatient() {
                this.$refs["rulesFormRef"].validate((valid) => {
                    if (valid) {
                        ...
                        InsertOperationName(this.form).then((res) => {
                            console.log(res);
                            if (res.data.code === 0) {
