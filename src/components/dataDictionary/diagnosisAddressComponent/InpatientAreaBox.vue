<template>
    <div>
        <el-dialog title="添加住院病区"  :visible.sync="dialogFormVisible" width="800px">
            <el-form :model="form" ref="rulesFormRef" :rules="rulesForm">
                <el-row >
                    <el-col :span="12">
                        <el-form-item label="病区代码" :label-width="formLabelWidth" prop="dm">
                            <el-input v-model="form.dm" size="small"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="病区名称" :label-width="formLabelWidth"  prop="dmmc">
                            <el-input v-model="form.dmmc" size="small"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="序号" :label-width="formLabelWidth"  prop="kbxh">
                            <el-input v-model="form.kbxh" size="small"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="床位数" :label-width="formLabelWidth"  prop="cws">
...
<script>
    import { InsertInpatientArea } from "../../../api/index";
    export default {
        components: {
        },
        props: {
            ...
            addOutpatient() {
                this.$refs["rulesFormRef"].validate((valid) => {
                    if (valid) {
                        ...
                        InsertInpatientArea(this.form).then((res) => {
                            console.log(res);
                            if (res.data.code === 0) {
