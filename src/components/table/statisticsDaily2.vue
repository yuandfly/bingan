        ...
        <template v-for="(data, index) in manyData">
          ...
          <el-table  :data="data" :key="index"    stripe border style="width: 100%;margin-bottom: 180px;">
            <el-table-column :label="aggregate" align="center" width>
              ...
              <el-table-column prop="tjm2009" label="门诊人次" align="center" width="50px"></el-table-column>
              <el-table-column label="其中" align="center" width>
                <el-table-column prop="name" label="专科人次" align="center" width="50px"></el-table-column>
                <el-table-column prop="name" label="专家人次" align="center" width="50px"></el-table-column>
              </el-table-column>
              <el-table-column prop="tjm2012" label="急诊人次" align="center" width="50px"></el-table-column>
            </el-table-column>
            <el-table-column label="住 院 部 分" align="center" width>
              ...
              <el-table-column label="出院人数" align="center" width>
                <el-table-column prop="tjz1005" label="合计" align="center" width="60px"></el-table-column>
                <el-table-column prop="tjz1010" label="死亡" align="center" width="60px"></el-table-column>
              </el-table-column>
              <el-table-column prop="tjz1015" label="转往他科" align="center" width="60px"></el-table-column>
              <el-table-column prop="tjz1016" label="留院人数" align="center" width="60px"></el-table-column>
              <el-table-column prop="kcs" label="空床数" align="center" width="60px"></el-table-column>
              <el-table-column prop="tjz1018" label="危重病人" align="center" width="60px"></el-table-column>
              <el-table-column prop="name" label="病床使用率%" align="center" width="60px"></el-table-column>
              <el-table-column prop="tjz1019" label="陪伴人数" align="center" width="60px"></el-table-column>
            </el-table-column>
          </el-table>
        </template>
      </template>
      <template v-else>
        ...
        <el-table :data="tableData" id="out-table" stripe border style="width: 100%">
          <el-table-column :label="aggregate" align="center" width>
            ...
            <el-table-column label="其中" align="center" width>
              <el-table-column prop="name" label="专科人次" align="center" width></el-table-column>
              <el-table-column prop="name" label="专家人次" align="center" width></el-table-column>
            </el-table-column>
          ...
          <el-table-column label="住 院 部 分" align="center" width>
            ...
            <el-table-column prop="name" label="病床使用率%" align="center" width></el-table-column>
      ...
      if (this.dateList.dateValue) {
        SelectHospitalStatistics({
          ...
          if (res.code === 0) {
            ...
            this.aggregate +=
              ": " +
              (this.tableData[0].tjm2009 ? this.tableData[0].tjm2009 : 0);
            showOkMsg(res.msg);
          }
        });
      } else {
