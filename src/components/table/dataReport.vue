  ...
  <div>
    ...
    <div v-show="this.dateList.audit === '2'">
      ...
      <el-table :data="tableData" stripe border style="width: 100%" >
        <el-table-column prop="dm" label="病案号" align="center">
...
import { selectResultSum, zyShangbao, QueryPatient, getHomeList } from "@/api";
  ...
  methods: {
    ...
    getUrl(resObj) {
      zyShangbao({
        ...
        .then((res) => {
          if (res.code === 0) {
            this.sumTableData = resObj.data.ResultSum;
            console.log(this.sumTableData);
            this.tableData = resObj.data.ResultSumDetails;
    ...
    exportExcel() {
      ...
      const headerDisplay = {dm:"病案号", error:"问题所在", zt:"类型", name: '名称', sj: '时间'};
