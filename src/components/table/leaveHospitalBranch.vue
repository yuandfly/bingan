<template>
  ...
  <div>
    ...
    <el-table :data="tableData" stripe border style="width: 100%">
      ...
      <el-table-column prop="ssmc" label="手术名称" align="center" width></el-table-column>
      ...
      <el-table-column prop="baza46" label="抢救次数" align="center" width></el-table-column>
      <el-table-column prop="baza43" label="门出诊断符合" align="center" width></el-table-column>
      <el-table-column prop="baza44" label="入出诊断符合" align="center" width></el-table-column>
      <el-table-column prop="baf411" label="手术日期" align="center" width></el-table-column>
      <el-table-column prop="baf406" label="手术前后诊断" align="center" width></el-table-column>
      <el-table-column prop="dj" label="切口及愈合" align="center" width></el-table-column>
      <el-table-column prop="bazac1" label="临床及病理" align="center" width></el-table-column>
      ...
      if (this.dateList.dateBegin && this.dateList.dateEnd) {
        branchRegistration({
          ...
          if (res.code === 0) {
            ...
            this.num = this.tableData ? this.tableData[0].bkls : 0;
            showOkMsg(res.msg);
          }
        });
      } else {
