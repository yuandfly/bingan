  ...
  <div id="print">
    ...
    <template v-if="manyData.length > 0 && tableIsShow">
      <el-table v-for="(data, index) in manyData" :data="data" :key="index"    stripe border style="width: 100%;margin-bottom: 180px;">
        ...
        <el-table-column prop="amount1" label="合计"></el-table-column>
        <el-table-column prop="amount2" label="门诊工作量"></el-table-column>
        <el-table-column prop="amount3" label="住院工作量"></el-table-column>
        <el-table-column prop="amount4" label="阳性数"></el-table-column>
      </el-table>
    </template>
    <template v-else>
