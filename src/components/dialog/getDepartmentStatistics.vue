<template @keyup.113.native="created">
	<el-dialog title="代码录入窗口" :visible.sync="visible" @close="$emit('update:show2', false)" :show="show2" width="20%" :modal="false"
	 @opened="AUTO()">
		<el-form :inline="true" :model="formInline" class="demo-form-inline" size="mini">
			<el-form-item label="拼音码" v-if="qun===1">
				<el-input v-model="formInline.pym" ref="input1" @input="queryAll()"></el-input>
			</el-form-item>

			<el-form-item label="五笔码" v-if="qun===2">
				<el-input v-model="formInline.wbm" ref="input1" @input="queryAll()"></el-input>
			</el-form-item>

			<el-form-item label="YB码" v-if="qun===3">
				<el-input v-model="formInline.ybm" ref="input1" @input="queryAll()"></el-input>
			</el-form-item>
		</el-form>
...
<script>
	...
	export default {
		...
		methods: {
			...
			dialog(row) {
				this.$parent.fatherMethod(row, this.msgs,2);
			},
			/**input框获取焦点*/
			AUTO() {
